...
export const createConnectionResolver = ({ projectId, engineToken, apiUrl, contextVersion, requestingPieceName }: CreateConnectionResolverParams): ConnectionResolver => {
    return {
